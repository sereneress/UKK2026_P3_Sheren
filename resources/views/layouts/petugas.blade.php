...
<div class="dashboard-main-wrapper">
                        ...
                        <div class="dropdown-menu dropdown-menu-right nav-user-dropdown">
                            ...
                            <div class="nav-user-info">
                                <h5 class="mb-0 text-white">
                                    {{ auth()->user()->petugas->nama ?? 'Petugas' }}
                                </h5>
    ...
    <div class="nav-left-sidebar sidebar-dark">
        <div class="menu-list">
            ...
            <!-- ICON HEADER -->
            <div class="d-flex align-items-center px-3 mt-3 mb-2">
            ...
            <nav class="navbar navbar-expand-lg navbar-light p-0">
                <div class="collapse navbar-collapse show">
                    ...
                    <ul class="navbar-nav flex-column w-100">
                        ...
                        <li class="nav-item">
                            <a class="nav-link px-3 {{ request()->routeIs('petugas.dashboard') ? 'active' : '' }}"
                               href="{{ route('petugas.dashboard') }}">
                                <i class="fa fa-home mr-2"></i> Dashboard Petugas
                            </a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a class="nav-link px-3 {{ request()->routeIs('petugas.aspirasi.*') ? 'active' : '' }}"
                               href="{{ route('petugas.aspirasi.index') }}">
                                <i class="fa fa-list mr-2"></i> Data Aspirasi
                            </a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link px-3 {{ request()->routeIs('petugas.history') ? 'active' : '' }}"
                               href="{{ route('petugas.history') }}">
                                <i class="fa fa-history mr-2"></i> History Aspirasi
                            </a>
                        </li>
